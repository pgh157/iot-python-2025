...
boldFont = Font(family = "NanumGothic", size=10, weight=BOLD, slant=ITALIC) # 글자 진하게, 이탤릭

# 2. UI 화면 구성
inputFrame = Frame(root, width=730, height=30, bg="#EFEFEF")
inputFrame.pack(side = BOTTOM, fill=BOTH)

# 3. inputFrame에 들어갈 Entry와 Button 구성 $(텍스트는 여러줄 ,엔트리는 한줄) $(wrap = WORD 글자순으로 자동 줄바꿈) 
#$ inputFrame 밑에 작성해야 함.
