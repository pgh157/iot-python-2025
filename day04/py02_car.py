...
# myCar.__plateNumber= "54라9538"  # 클래스 외부에서 잘못된 데이터를 넣어도 문제가 발생X (문제 발생없고 안들어감)
# print(myCar)

# myCar.setPlateNumber(549999) # 잘못된 타입적으면 안들어감.
# print(myCar)
