...
choice = IntVar()
Radiobutton(root, text="C", value=1, variable = choice).pack(anchor=W)  #$ choice 해야지 첨에 아무것도 안누른 상태 , achor =W 왼쪽으로
...
# 체크버튼(박스)
Label(root, text = "좋아하는 과일을 모두 선택").pack(anchor=W)
orange = IntVar()
